...
CustomMessages
    messages = [
        ...
        // actor is here / actor here — handled by actorSpecialDesc() override in swe_mods.t
        
        //TODO: Msg(actor in location, '\^<<theNameIs>> <<postureDesc>> <<location.objInName>>. ');        		
        ...
        Msg(no clear exits, 'Det är inte klart var {jag} {kan} gå härifrån. '),
        Msg(exits from here, 'Härifrån kan {jag} gå '),
        ...
        //TODO: Msg(report take, 'Tag{en/et/na}. | {jag} {tar} {1}. '),
        //TODO: DMsg(report take, 'Taken. | {I} {take} {1}. ', gActionListStr);
        ...
        //Msg(cannot detach from, 'There{dummy} {is}n\'t anything that could be detached from {the iobj}. ')
        Msg(cannot detach this, '{Ref subj dobj} {kan} inte lossas från {1}. '),
        
        // TODO: remove this, no longer in use:
        ...
        */
        ...
        //Msg(not important, '{Ref subj dobj} {är} inte viktig{t/a}. '), // TODO: lägg till viktig{t/a}
        Msg(not important, '{Ref subj cobj} {är} inte viktig{t/a}. '), 
        // TODO: 's' måste om det ska användas både i '
        // [ 's', { ctx, params: ctx.lastParamPlural() ? 'a' : '' } ],
        // och p ådet andra stället, var det nu var...
        ...
        Msg(okay get outof, 'Okej, {jag} g{år|ick} ut ur {ref dobj}. '),
        ...
        //Msg(move no effect, 'Moving {1} {dummy} {has} no effect. '),
