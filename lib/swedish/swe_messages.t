...
CustomMessages
    messages = [ 
        ...
        Msg(follow, '<.p>{ref follower} följer efter {ref pc}. '),
        ...
        Msg(say head after actor, '{Jag} g{ick|år} {1} efter {2}. '),
        Msg(state follow, '{Ref follower} följer efter {ref pc}. '),
        ...
        Msg(say following up staircase, '{Ref subj follower} följer {ref leader} upp {1}. '),
        Msg(say departing down stairs, '{Ref subj traveler} {går} ner {1}. '),
        Msg(say following down staircase, '{Ref subj follower} följer {ref leader} ner {1}. '),
        Msg(click, 'Klick!'), 
        ...
        Msg(report unlock, okayUnlockMsg),
        Msg(report lock, okayLockMsg),
        ...
        Msg(say following through door, '{Ref subj follower} följer {ref leader} genom {1}. '),
        ...
        Msg(say following vague, '<.p>{ref subj follower} följer {ref leader}. '),
        Msg(say following dir, '<.p>{ref subj follower} följer {ref leader} {1}. '),
        ...
        Msg(follow actor, '{Jag} följer {1}. '),
        Msg(actor stays put, '{Jag} väntar förgäves på att {1} ska gå någonstans. '),
        ...
        Msg(okay sit on, '{Jag} sitter på {1}. '),
        Msg(okay lie on, '{Jag} ligger på {1}. '),
        ...
        Msg(reveal move behind,'Flyttar {1} {dummy} avslöjar {2} tidigare gömd bakom {3}. '),
