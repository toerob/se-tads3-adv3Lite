...
CustomMessages
    messages = [ 
        ...
        Msg(jump, '{Jag} hoppa{r/de} på stället, fruktlöst. '),
        ...
        Msg(not interlocutor, '{Jag} {pratar} inte med {1}. '),
        ...
        Msg(okay plug in, '{Jag} koppla{r/de} in {1}. '),
        ...
        Msg(not enough nouns, '{Jag} {ser} inte så många {2} här.'), 
        Msg(none in owners, 'Jag förstår inte vem "{2}" syftar på.'),
        Msg(none in owner, '{Ref subj obj} verka{r/de} inte ha någon {2}.'),
        Msg(none in locations, '{Jag} {ser} ingen {2} {3} någon {4}.'),
        Msg(none in location, '{Jag} {ser} ingen {2} {3} {ref 4}.'),
        Msg(none with contents in list, '{Jag} {ser} ingen {2} av {3}.'),
        Msg(none with contents, '{Jag} {ser} ingen {2} av {3}.'),
        Msg(be more specific, 'Jag vet inte vilka du menar. Kan du vara mer specifik?'),
        Msg(ordinal out of range, 'Tyvärr, {ser} jag inte vad du hänvisar till.'),
        ...
        Msg(throw dir, '{Jag} kasta{r/de} {ref obj} {1} och {he obj} landa{r/de} på marken. '),
        Msg(okay open, 'Öppna{d/t/da}. |{Jag} {öppnar} {1}. '),
        ...
        Msg(throw, '{Ref subj obj} segla{r/de} genom luften och landa{r/de} på marken. '),
        Msg(okay get on, '{Jag} g{ick|år} på {1}. '),
        Msg(okay get in, '{Jag} g{ick|år} in i {1}. '),
        Msg(okay move to, '{Jag} flytta{r/de} {1} {dummy} till {ref iobj}. '),
        Msg(okay lit,'Gjort.|{Jag} {tänder} {1}. '),
        Msg(extinguish, '{Jag} {släcker} {1}. '),
        Msg(eat, '{Jag} {äter} {1}. '),
        Msg(okay clean, 'Rengjord|{Jag} ren{gör} {1}. '),
        Msg(throw at, '{Ref subj obj} träffa{r/de} {ref iobj} och landa{r/de} på marken. '),
        ...
        Msg(jump off, '{Jag} hoppa{r/de} av {1} och landa{r/de} på marken'),
        Msg(before push travel dir, '{Jag} {trycker} {ref dobj} {1}. '),
        ...
        Msg(purloin, '{Jag} upptäcker {mig} plötsligt hållandes {1}. '),
        ...
        Msg(should not kiss, 'Det verka{r/de} knappast vara en bra idé att kyssa {ref dobj}. '),
        Msg(kiss response, '{Ref subj dobj} {gillar} inte att bli kysst. '),
        Msg(cannot attack actor, 'Det verka{r/de} knappast vara en bra idé att attackera {ref dobj}. '),
        ...
        Msg(okay detach, '{Jag} lossa{r/de} {1}. '),
        Msg(okay detach from, '{Jag} lossa{r/de} {1} från {ref iobj}. '),
        ...
        Msg(okay plug, '{Jag} koppla{r/de} in {1} i {ref iobj}. ') ,
        ...
        Msg(indirect lockable,'{ref dobj} verka{r/de} använda någon annan typ av låsmekanism. '),
        ...
        Msg(throw falls short, '{Ref subj dobj} landa{r/de} långt ifrån {ref iobj}. '),
        ...
        Msg(cannot talk basicactor, '{Ref subj cobj} verka{r/de} inte intresserad. '),

        Msg(okay push into, '{Jag} <<if matchPullOnly>> {drar} {ref dobj} {1} {2}. '),
        Msg(okay push into, '{Jag} <<if matchPullOnly>>{drar} <<else>>{trycker}<<end>> in {ref dobj} i {ref iobj}. '),
        Msg(okay push out of, '{Jag} <<if matchPullOnly>>{drar} <<else>>{trycker}<<end>> ut {ref dobj} ur {ref iobj}. '),
